...
if( $user ){
// اضافه کردن رکورد جدید به جدول بازدید
$ip = $_SERVER['REMOTE_ADDR'];

$timestamp = date('Y-m-d H:i:s');

$sql = "INSERT INTO visits (ip, timestamp , username , ID) VALUES ('$ip', '$timestamp' , '$user->username' , '$user->ID')";
...
$sql      = "SELECT * FROM `products-men` " ; 
$query    = $connection->query($sql) ;
$products = $query->fetchAll(PDO::FETCH_OBJ) ; 

// get product women

$sql      = "SELECT * FROM `products-women` " ; 
$query    = $connection->query($sql) ;
$products_women = $query->fetchAll(PDO::FETCH_OBJ) ; 

// get product kid

$sql      = "SELECT * FROM `products-kid` " ; 
$query    = $connection->query($sql) ;
...
if(  isset($_GET['status']) and $_GET['status'] == "star"  )
{
    ...
    $sql  = " SELECT stars FROM `$product` WHERE ID=$POST_ID   " ; 
    ...
    $SQL = " UPDATE `$product` SET  stars = '$stars'  WHERE ID='$POST_ID' ";
                ...
                <div class="col-lg-12">
                    <div class="kid-item-carousel">
                        <div class="owl-kid-item owl-carousel">
                          ...
                          <?php foreach( $products_kid as $product ):  ?>
                            <div class="item">
                                <div class="thumb">
                                    <div class="hover-content">
                                        <ul>
